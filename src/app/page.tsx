          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 py-3">
              ...
              <div>
                ...
                <a href="https://www.linkedin.com/in/archittaneja/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">linkedin.com/in/archittaneja</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 py-3">
              ...
              <div>
                ...
                <a href="https://github.com/archittaneja" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-gray-200 transition-colors">github.com/archittaneja</a>
              </div>
            </div>
          </div>
        </div>
