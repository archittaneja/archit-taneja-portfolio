      ...
      <section id="contact" className="snap-section min-h-screen px-4 sm:px-6 lg:px-12 bg-[#1a1a1a] pt-20 md:pt-16 pb-12 overflow-y-auto flex items-center">
        <div className="max-w-2xl mx-auto w-full">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
            >
              Send Message
            </button>
          </form>
